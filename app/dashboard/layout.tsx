...
// Full-bleed app section — mirrors the existing /studio route's approach
// of defining its own <html>/<body> so the public site's Navbar, ticker,
// and footer never render inside the dashboard.
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en">
      <body style={{ margin: 0 }} className="bg-[#0B0B0F] text-white min-h-screen font-sans antialiased">
        {user ? (

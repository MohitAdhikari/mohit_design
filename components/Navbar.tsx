    ...
    >
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8 flex-1">
            ...
            <Link href="/tournaments" className={`relative transition-colors text-sm font-bold uppercase tracking-widest py-2 ${isActive('/tournaments') ? 'text-blue-600 dark:text-[#00E5FF]' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'}`}>
              Tournaments
              {isActive('/tournaments') && <span className="absolute bottom-[-1.25rem] left-0 w-full h-[3px] bg-[#00E5FF] shadow-[0_0_8px_rgba(0,229,255,0.8)]"></span>}
            </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-[#0B0B0F] border-b border-gray-200 dark:border-gray-800/50 px-4 pt-2 pb-6 space-y-2 shadow-2xl">
          ...
          <Link href="/tournaments" onClick={() => setIsOpen(false)} className={`block transition-colors text-base font-bold uppercase tracking-widest p-4 rounded-xl ${isActive('/tournaments') ? 'text-blue-600 dark:text-[#00E5FF] bg-blue-50 dark:bg-blue-900/10' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5'}`}>Tournaments</Link>

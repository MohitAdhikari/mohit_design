...
export default function Navbar({ logoUrl, siteName, logoTextSpacing = 8, logoOnTop = true }: NavbarProps) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="md:hidden fixed top-20 left-0 right-0 bottom-0 z-[60] overflow-y-auto bg-white/95 dark:bg-[#0B0B0F]/95 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800/50 px-4 pt-2 pb-6 space-y-2 shadow-2xl">
